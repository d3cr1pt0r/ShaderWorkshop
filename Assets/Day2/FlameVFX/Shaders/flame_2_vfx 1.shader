Shader "ShaderWorkshop/VFX/Flame_2_1"
{
	Properties {
...
//			Blend One One
			...
			fixed4 frag (fragmentInput i) : SV_Target {
				...
				//return tex2D(_MainTex, i.texcoord0.xy).a;
				...
				fixed3 mainTex = tex2D(_MainTex, i.texcoord0.xy + displacementTex1.xy).rgb;
				//return pow(i.texcoord0.y + _GradientOffset, _GradientPower);

				//return fixed4(displacementTex1.x, displacementTex1.y, 0, 1);
				return fixed4(mainTex.r, 0, 0, mainTex.r);
